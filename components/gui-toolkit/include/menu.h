...
bool    menu_insert_item(
       menu_t* menu, const char* label, menu_callback_t callback, void* callback_arguments, size_t position
   );
...
void menu_render_grid_changes(
    pax_buf_t* buffer, menu_t* menu, float position_x, float position_y, float width, float height
);
